...
public class MekanismItems {
    ...
    // TODO: Unsure how we should register colors and ItemRadioactive at the same time...
    public static final ItemRegistryObject<Item> PLUTONIUM_PELLET = ITEMS.register("pellet_plutonium", props -> new ItemRadioactive(0.02, props));
    public static final ItemRegistryObject<Item> POLONIUM_PELLET = ITEMS.register("pellet_polonium", props -> new ItemRadioactive(0.05, props));
    //public static final ItemRegistryObject<Item> PLUTONIUM_PELLET = ITEMS.register("pellet_plutonium", EnumColor.GRAY, props -> new ItemRadioactive(0.02, props));
    //public static final ItemRegistryObject<Item> POLONIUM_PELLET = ITEMS.register("pellet_polonium", EnumColor.INDIGO, props -> new ItemRadioactive(0.05, props));
